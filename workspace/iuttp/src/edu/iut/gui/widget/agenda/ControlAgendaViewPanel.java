...
public class ControlAgendaViewPanel extends JPanel {
	...
	public ControlAgendaViewPanel(CardLayout layerLayout, final JPanel contentPane) {
		...
		JComboBox<String> monthComboBox      = new JComboBox<String>(ApplicationSession.instance().getMonths());
		JComboBox<String> daysOfWeekComboBox = new JComboBox<String>(ApplicationSession.instance().getDays());
